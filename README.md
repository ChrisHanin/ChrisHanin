...
3D engine built in C using raycasting (inspired by early FPS games)

👉 https://github.com/ChrisHanin/cub3d-raycasting-engine  

---

### 🌐 ft_transcendence — Full-Stack Web App
Web application with backend, authentication, and real-time features

👉 https://github.com/ChrisHanin/ft_transcendence  

---

### 🔐 Cybersecurity Projects
Hands-on projects covering vulnerabilities, networking, and security basics

👉 https://github.com/ChrisHanin/cybersecurity_piscine  
